...
public final class ApplicationResources extends EditableResourceBundle {
	...
	static File getSourceFile(String filename) {
		return new File(System.getProperty("user.home") + "/maven2/ao/aoweb-struts/core/src/main/resources/com/aoindustries/web/struts/clientarea/control/i18n", filename);
	}
