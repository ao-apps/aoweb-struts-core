...
final public class ServerConfirmationCompletedActionHelper {
	...
	private static boolean sendSummaryEmail(
		...
		try {
			...
			+ "        "); html.hr__().out.write("\n"
			+ "    </td></tr>\n"
			+ "    <tr><th colspan=\"3\">"); html.text(PACKAGE_RESOURCES.getMessage("steps.selectServer.label")); html.out.write("</th></tr>\n");
			SignupSelectServerActionHelper.writeEmailConfirmation(html, packageDefinition);
			html.out.write("    <tr><td colspan=\"3\">&#160;</td></tr>\n"
			+ "    <tr><th colspan=\"3\">"); html.text(PACKAGE_RESOURCES.getMessage("steps.customizeServer.label")); html.out.write("</th></tr>\n");
			AOServConnector rootConn = siteSettings.getRootAOServConnector();
			SignupCustomizeServerActionHelper.writeEmailConfirmation(request, html, rootConn, packageDefinition, signupCustomizeServerForm);
			if(signupCustomizeManagementForm!=null) {
				html.out.write("    <tr><td colspan=\"3\">&#160;</td></tr>\n"
				+ "    <tr><th colspan=\"3\">"); html.text(PACKAGE_RESOURCES.getMessage("steps.customizeManagement.label")); html.out.write("</th></tr>\n");
