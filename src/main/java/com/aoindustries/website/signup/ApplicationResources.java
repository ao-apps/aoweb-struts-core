...
public final class ApplicationResources extends EditableResourceBundle {
	...
	public ApplicationResources() {
		super(
			new Locale(""),
			bundleSet,
			new File(System.getProperty("user.home")+"/maven2/ao/aoweb-struts/aoweb-struts-webapp/src/main/java/classes/com/aoindustries/website/signup/ApplicationResources.properties")
		);
	}
